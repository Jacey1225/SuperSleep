...
class PromptPlan:
    def __init__(self, user_stats, critical_factors, goal, progress_speed):
        ...
        self.default_prompt = f"You are a helpful sleep assistant that provides specific advice to help the user {goal} " \
        ...
        self.plan = f"Given this information, can you give the user some changes to gradually commit to over {progress_speed} that will help them raise their sleep quality? "
        self.format = "Please format your response as a categorized list of the lacking factors, " \
        "the changes to make, and how many days per week each should be committed to given how demanding the change is."
